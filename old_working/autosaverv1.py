...
def save_book1_simple(target_title):
    """Simple DDE save operation matching the successful test."""
    ...
    try:
        # Create DDE server (matching test approach)
        ...
        # Simple save operation (exactly like successful test)
...
def restore_minimized_windows(minimized_windows):
    ...
    print(f"🔼 Restoring {len(minimized_windows)} Excel windows...")
...
def main():
    print("Excel Book1 Auto-Saver (Simplified)")
    print("=" * 40)
